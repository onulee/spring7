		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<script>
					  function confirmBtn(){
						  console.log("체크박스 개수 : ",$("input[type='checkbox']").length)
						  console.log("체크된 개수 : ",$("input[type='checkbox']:checked").length)
						  const num = $("input[type='checkbox']:checked").length;
						  if(num==3){
							  alert('다음 단계로 회원가입을 진행합니다.');
						  	  location.href="/member/step03";
						  }else{
							  alert("모두 동의를 해주셔야 다음으로 진행가능합니다.");
						  }
					  }
					</script>
